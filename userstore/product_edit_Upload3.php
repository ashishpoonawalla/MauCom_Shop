			...
			if(strlen($name))
				{
                  ...
                  mysqli_query($db,"UPDATE zz".$_SESSION["mobile"]."products SET image3='$actual_image_name1' where productid=".$_SESSION["pid"]);
									
									echo "<img src='uploads/".$actual_image_name."'  class='preview3'  height='120px'>";
								}
							else
