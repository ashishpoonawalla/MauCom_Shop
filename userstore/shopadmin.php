...
<!-- Headning Login -->
	<div class="row clearfix">
		...
		<div class="col-md-4 column">
			...
			echo "<br/><h3><a href='../a/".$_SESSION["mobile"]."' target='blank'>My Store</a></h3>";
			//echo "<br/>".$_SESSION["mobile"] ;
			?>
			
			<?php

				echo "<h3><a href='product.php' >Product</a></h3>";
				
				echo "<h3><a href='category.php' >Category</a></h3>";
				
				echo "<h3><a href='brand.php' >Brand</a></h3>";
		...
		<div class="col-md-8 column">
			...
			<div class="col-md-6 column">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="col-md-8 column">
									<img src="../img/order.jpg" style="height: 70px" />
							</div>
							<div class="col-md-4 column">
									<h1><?php echo $ordercnt; ?></h1>
							</div>
						</div>
						<div class="panel-footer">
								...
								<div class="row clearfix">
									...
									<div class="col-md-6 column">
										<p class="text-right">Rs. <?php echo $ordertot; ?></p>
									</div>
								</div>
			...
			<div class="col-md-6 column">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="col-md-8 column">
								<img src="../img/shopping_bag.png" style="height: 70px" />
							</div>
							<div class="col-md-4 column">
								<h1><?php echo $salecnt; ?></h1>
							</div>
						...
						<div class="panel-footer">
							<div class="row clearfix">
								...
								<div class="col-md-6 column">
									<p class="text-right">Rs. <?php echo $saletot; ?></p>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="row clearfix">
		...
		<div class="col-md-12 column">
			...
			<div class="jumbotron">
			  ...
			  <p>we help you to control sale of your Online Shop.</p>
