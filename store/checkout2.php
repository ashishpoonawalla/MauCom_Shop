...
<!-- Site Map -->
	...
	<h3>Checkout</h3>
	<b>Change Delivery address if you your delivery address is other than billing address..</b><br/>
...
<!--            ---------------------------------------- 3 Delivery Information -------- -->
		<div class="panel panel-default">
			<div class="panel-heading">
					<a class="panel-title" data-toggle="collapse" data-parent="#panel-998897" href="#">Step 3: Delivery Information</a> 
			</div>
			<div id="panel-element-11111" class="panel-collapse collapse in">
				<div class="panel-body">
							
					
				 		<form data-toggle="validator" role="form" method="POST" action="checkout3.php">
							  ...
							  <div class="row clearfix">
								...
								<div class="col-md-6 column">
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="First Name" name="firstname3" value="<?php echo $_SESSION["firstname3"]; ?>" required/>

										</div>
										<div class="form-group">
										
											<label for="Last Name">Last Name *</label>
											<input type="text"  class="form-control" Placeholder="Last Name" name="lastname3" value="<?php echo $_SESSION["lastname3"]; ?>" required/>
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="Mobile" name="mobile3" value="<?php echo $_SESSION["mobile3"]; ?>" required/>
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="Telephone" name="telephone3" value="<?php echo $_SESSION["telephone3"]; ?>" />
										...
										<div class="form-group">
											...
											<input type="email"  class="form-control" Placeholder="Email" name="email3_1"  value="<?php echo $_SESSION["email3_1"]; ?>" />
								...
								<div class="col-md-6 column">
									...
									<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="Address1" name="address1" value="<?php echo $_SESSION["address1"]; ?>" required/>

										</div>
										<div class="form-group">
										
											<label for="exampleInputEmail1">Address 2 </label>
											<input type="text"  class="form-control" Placeholder="Address2" name="address2" value="<?php echo $_SESSION["address2"]; ?>" />

										</div>
										<div class="form-group">
										
											<label for="city">City *</label>
											<input type="text"  class="form-control" Placeholder="City" name="city3" value="<?php echo $_SESSION["city3"]; ?>" required/>

										</div>
										<div class="form-group">
											 <label for="postcode">Zip or Postal Code *</label>
											 <input type="text" class="form-control" Placeholder="Postcode" name="postcode3" value="<?php echo $_SESSION["postcode3"]; ?>" required/>
										</div>
										
										<div class="form-group">
											<label for="postcode">Country *</label>
											 <select class="form-control" id="select" name="country3">
													...
													<?php
														...
														while($row=mysqli_fetch_array($result))
														{
															if ($row["country_name"] == $_SESSION["country3"])
																echo	"<option selected='selected'>".$row["country_name"]."</option>";
															else
										...
										<div class="form-group" >
											...
											<input type="text"  class="form-control" Placeholder="State" name="state3" value="<?php echo $_SESSION["state3"]; ?>" required/>
