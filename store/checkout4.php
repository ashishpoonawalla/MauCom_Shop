...
<!--            ---------------------------------------- 1 Checkout option -------- -->
		<div class="panel panel-default">
			<div class="panel-heading">
					<a class="panel-title" data-toggle="collapse" data-parent="#panel-998897" href="#panel-element-11111">Step 4: Confirm Order</a>
			</div>
			<div id="panel-element-11111" class="panel-collapse collapse in">
				<div class="panel-body">
							...
							<div class="row clearfix">
								<div class="col-md-12 column">
									<?php include("checkout_detail.php"); ?>
								</div>
							</div>

							<br/>
							<p class="text-right">
								<a href="checkout4_finalorder.php" class="btn btn-primary">Confirm Order</a>
							</p>
