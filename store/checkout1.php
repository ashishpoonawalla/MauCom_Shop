...
<!--            ---------------------------------------- 2 Customer Information -------- -->
		<div class="panel panel-default">
			<div class="panel-heading">
					<a class="panel-title" data-toggle="collapse" data-parent="#panel-998897" href="#">Step 2: Customer Information</a> 
			</div>
		...
		<?php 
				...
				?>
				 		<form data-toggle="validator" role="form" method="POST" action="checkout1_regis.php">
				<?php
				}
				else
				{
					?>
				 		<form data-toggle="validator" role="form" method="POST" action="checkout1_guest.php">
				<?php
				}
				?>
							  <div class="row clearfix">
								...
								<div class="col-md-6 column">
									<?php 
										...
										<div class="form-group">
											...
											<input type="email"  class="form-control" Placeholder="Email" name="email3"  required/>
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="First Name" name="firstname3" required/>

										</div>
										<div class="form-group">
										
											<label for="Last Name">Last Name *</label>
											<input type="text"  class="form-control" Placeholder="Last Name" name="lastname3" required/>
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="Mobile" name="mobile3"  required/>
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="Telephone" name="telephone3"  />
										...
										<div class="form-group">
											...
											<input type="email"  class="form-control" Placeholder="Email" name="email3_1"  />
								...
								<div class="col-md-6 column">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text"  class="form-control" Placeholder="City" name="city3" required/>

										</div>
										<div class="form-group">
											 <label for="postcode">Zip or Postal Code *</label>
											 <input type="text" class="form-control" Placeholder="Postcode" name="postcode3" required/>
										</div>
										...
										<div class="form-group" >
											...
											<input type="text"  class="form-control" Placeholder="State" name="state3" required/>
