<?php
		      ...
		      $query="";
          if (trim($_SESSION["category1"]) == "")
          {
          
					    $query="SELECT * FROM zz".$_SESSION["mobile1"]."products order by productname";
					
          }
          else
          {
          
              $query="SELECT * FROM zz".$_SESSION["mobile1"]."products Where productName='".$_SESSION["category1"]."' OR categoryID='".$_SESSION["category1"]."' OR brand='".$_SESSION["category1"]."'";
