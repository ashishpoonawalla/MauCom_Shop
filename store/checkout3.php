...
<?php
		...
		$_SESSION["firstname3D"] =$firstname3;
		$_SESSION["lastname3D"] = $lastname3;
		
		$_SESSION["address1D"] = $address3_1;
		$_SESSION["address2D"] = $address3_2;
		$_SESSION["city3D"] = $city3;
		$_SESSION["postcode3D"] = $postcode3;
		$_SESSION["country3D"]= $country3;
		$_SESSION["state3D"] = $state3;
		
	
		$_SESSION["mobile3D"] = $mobile3;
		$_SESSION["telephone3D"] = $telephone3;
		$_SESSION["email3_1D"] = $email3_1;
 ...
 <div class="row clearfix">
	...
	<div class="panel-group" id="panel-998897">
				...
				<div class="panel panel-default">
					...
					<a class="panel-title" data-toggle="collapse" data-parent="#panel-998897" href="#">Step 4: Payment Information</a> 
				</div>

				<div id="panel-element-11111" class="panel-collapse collapse in">
					<div class="panel-body">

							<form data-toggle="validator" role="form" method="POST" action="checkout4.php">
										...
										<div class="col-md-12 column">
											...
											<div class="form-group">
											  ...
											  <div class="col-lg-10">
												...
												<span class="help-block">Add Comment About Your Order </span>
											  </div>
											</div>
