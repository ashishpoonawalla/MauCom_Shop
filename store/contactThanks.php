...
<?php
		...
		// Check connection
			...
			$stmt = $conn->prepare("INSERT INTO zz".$_SESSION["mobile1"]."mail ( smail, sname, smessage, sdate, sstatus) values( ?, ?, ?, ?, ?) ");
			$stmt->bind_param("sssss", $smail, $sname, $smessage, $sdate, $sstatus  );
		...
		$to = $email12;
		$subject = "MauComShop.Com - Contact us message";
		...
		// More headers
		$headers .= 'From: <info@maucom.co.in>';
