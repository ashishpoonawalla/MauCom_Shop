		...
		<div class="col-md-3 column" >
					 ...
					 <ul class="nav nav-pills">
						<li class="active">
								...
								<!-- <a href="cart_session_del.php?var1=<?php echo $_SESSION["mobile1"];  ?>" > -->
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									Do you really want to remove shopping cart items ?
									<br/><br/>
									 <form role="form" method="POST" action="cart_session_del.php">
											<div class="form-group">
												<input type="hidden"  class="form-control" name="mobile12" value="<?php echo $_SESSION["mobile1"];  ?>" />
...
<!-- Product Detail -->
      ...
      <?php include("shopping_cart_detail.php"); ?>
  ...
  <div class="row clearfix">
		...
		<div class="col-md-6 column">
			<p class="text-left">
				<a class="btn btn-default" href="shop.php?var1=<?php echo $_SESSION["mobile1"];  ?>">Continue Shopping</a>
			</p>
        </div>
        <div class="col-md-6 column">
			<p class="text-right">
				<a class="btn btn-primary" href="checkout.php?var1=<?php echo $_SESSION["mobile1"];  ?>">Checkout</a>
			</p>
        </div>
